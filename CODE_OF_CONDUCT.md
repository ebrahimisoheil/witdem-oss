...
We pledge to make participation in the Witdem community a harassment-free
...
contributions that are not aligned with this Code of Conduct. Maintainers may
temporarily or permanently restrict participation for behavior they consider
...
project maintainers through GitHub. Do not open a public issue containing private
or sensitive details. Reports will be reviewed promptly and fairly, and the
privacy and safety of the reporter will be respected.

## Enforcement guidelines

Maintainers will consider the context, severity, and impact of a violation when
choosing a response. Responses may range from a private correction or warning to
a temporary or permanent ban from project interaction.
