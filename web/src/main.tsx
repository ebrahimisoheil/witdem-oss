...
import { ComparePage, DeveloperPage, GoalPerformancePage, IssuesPage, OverviewPage, RunPage, RunsPage, SystemHealthPage } from "./pages";
import { WorkflowDefinitionPage, WorkflowDefinitionsPage, WorkflowExecutionPage } from "./workflow-pages";
import "./styles.css";
