"""Ollama with standard OpenTelemetry only."""
...
provider = TracerProvider(resource=Resource.create({"service.name": "witdem-example-ollama-basic"}))
provider.add_span_processor(BatchSpanProcessor(OTLPSpanExporter()))
trace.set_tracer_provider(provider)

with trace.get_tracer(__name__).start_as_current_span("ollama.chat") as span:
